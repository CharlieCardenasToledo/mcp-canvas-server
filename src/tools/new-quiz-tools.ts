...
export const newQuizTools: ToolDefinition[] = [
    {
        ...
        tool: {
            name: "canvas_create_new_quiz",
            description:
                "Create a New Quiz (LTI) in a course. Use this for Canvas's modern quiz engine (not Classic Quizzes).",
            inputSchema: {
                type: "object",
                properties: {
                    course_id: {
                    ...
                    instructions: {
                        type: "string",
                        description: "HTML instructions shown to students before starting"
                    },
    ...
    },
    {
        ...
        tool: {
            name: "canvas_create_new_quiz_item",
            description:
                "Add a question/item to a New Quiz (LTI). Supports multiple choice, true/false, essay, fill-in-blank, matching, and more.",
            inputSchema: {
                type: "object",
                properties: {
                    course_id: {
                    ...
                    interaction_type_slug: {
                        type: "string",
                        description:
                            "Question type: choice (multiple choice), true-false, essay, short-answer, matching, ordering, file-upload, categorization, hot-spot"
                    },
                    interaction_data: {
                        type: "object",
