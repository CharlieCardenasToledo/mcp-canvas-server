...
export const analyticsTools: ToolDefinition[] = [
    ...
    },
    {
        ...
        tool: {
            name: "canvas_get_student_analytics",
            description:
                "Get activity analytics for a specific student in a course (page views, participations, tardiness breakdown)",
            inputSchema: {
                type: "object",
                properties: {
                    course_id: {
    ...
    },
    {
        ...
        tool: {
            name: "canvas_search_course_content",
            description:
                "Search for content across a course by keyword (assignments, pages, discussions, quizzes, files)",
            inputSchema: {
                type: "object",
                properties: {
                    course_id: {
                    ...
                    content_types: {
                        ...
                        items: { type: "string" },
                        description:
                            "Limit search to specific types: assignments, pages, discussion_topics, quizzes, files. Defaults to all."
                    }
                },
