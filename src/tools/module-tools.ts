...
export const moduleTools: ToolDefinition[] = [
    ...
    },
    {
        ...
        tool: {
            name: "canvas_update_module",
            description:
                "Update an existing module (name, published, position, prerequisites, completion requirements)",
            inputSchema: {
                type: "object",
                properties: {
                    course_id: {
                    ...
                    completion_requirements: {
                        type: "array",
                        description:
                            "Completion requirements for module items. Replaces ALL existing requirements — include every item that needs one.",
                        items: {
                            type: "object",
                            properties: {
    ...
    },
    {
        ...
        tool: {
            name: "canvas_create_module_item",
            description:
                "Create a module item (Assignment, Quiz, File, Page, DiscussionTopic, ExternalUrl, ExternalTool, or SubHeader)",
            inputSchema: {
                type: "object",
                properties: {
                    course_id: {
                    ...
                    type: {
                        type: "string",
                        description:
                            "The type of item (Assignment, Quiz, File, Page, DiscussionTopic, ExternalUrl, ExternalTool, SubHeader)"
                    },
                    content_id: {
            ...
            inputSchema: {
                ...
                properties: {
                    ...
                    completion_requirement_type: {
                        type: "string",
                        description:
                            "Completion requirement type: must_view, must_submit, must_contribute, min_score, must_mark_done"
                    }
                },
